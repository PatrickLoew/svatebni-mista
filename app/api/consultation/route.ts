        ...
        html: `
          <div style="font-family:Helvetica,Arial,sans-serif;background:#F9F6F0;padding:40px 20px">
            <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden">
              <div style="background:#1F3A2C;padding:40px;text-align:center;color:#fff">
              ...
              <div style="padding:30px;color:#444;line-height:1.7;font-size:15px">
                ...
                <p>Náš wedding planner se vám ozve <strong>do 24 hodin</strong> s návrhem konkrétních termínů.</p>
              ...
              <div style="background:#0F1F18;padding:20px;text-align:center;color:rgba(255,255,255,.4);font-size:11px">© Svatební Místa.cz</div>
            </div>
          </div>
        `,
      })
